...
def load_jwt_blacklist_class():
    """Load the JWTBlacklist class directly."""
...
async def test_jwt_blacklist():
    ...
    try:
        # Load JWTBlacklist class
        JWTBlacklist = load_jwt_blacklist_class()
        ...
        blacklist = JWTBlacklist(mock_redis)
    ...
    try:
        ...
        class MockAuthService:
            ...
            def revoke_access_token(self, token):
                ...
                return blacklist.blacklist_token(token)
